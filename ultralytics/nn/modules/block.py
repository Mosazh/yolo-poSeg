...
# https://blog.mvui.cn/detail/212995.html
...
""" C3STR """
#----------swintf----C3STR---------------------------------
from .SwinTransformer import SwinTransformer2Block as SwinTransformerBlock
...
class C3STR(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        if c2 > 32:
            ...
            c_ = c2
        num_heads = c_ // 32
        self.m = SwinTransformerBlock(c_, c_, num_heads, n, window_size=8)
