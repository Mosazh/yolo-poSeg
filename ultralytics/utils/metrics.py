...
""" custom Metrics of PoSeg """
class PoSegMetrics(SimpleClass):
    """
    Calculates and aggregates detection, pose and segmentation metrics over a given set of classes.
    ...
    def __init__(self, save_dir=Path("."), plot=False, on_plot=None, names=()) -> None:
        """Initialize the PoSegMetrics class with directory path, class names, plot flag, callback function, class names and plotting options."""
        # super().__init__(save_dir, plot, names)
        self.save_dir = save_dir
        self.plot = plot
        self.on_plot = on_plot
